...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getBannerslide()->getTitle());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_bannerslide');
    }
    ...
    {
        return $this->getUrl('bannerslide/index/index');
    }
