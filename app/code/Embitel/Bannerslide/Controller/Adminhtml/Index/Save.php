    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (!$this->dataProcessor->validate($data)) {
                $this->_redirect('*/*/edit', ['bannerslide_id' => $model->getId(), '_current' => true]);
                return;
            }

            try {
                $imageHelper = $this->_objectManager->get('Embitel\Bannerslide\Helper\Data');
            ...
            $this->_redirect('*/*/edit', ['bannerslide_id' => $this->getRequest()->getParam('bannerslide_id')]);
            return;
        }
        $this->_redirect('*/*/');
    }
