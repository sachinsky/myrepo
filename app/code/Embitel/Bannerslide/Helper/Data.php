...
/**
 * Bannerslide data helper
 */
namespace Embitel\Bannerslide\Helper;
...
{
    /**
     * Path to store config where count of bannerslide posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'bannerslide/view/items_per_page';
    ...
    /**
     * Remove Bannerslide item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Embitel\Bannerslide\Model\Bannerslide $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Bannerslide Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Bannerslide Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getBannerslidePerPage()
    {
