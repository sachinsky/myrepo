    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Embitel\SliderModel\Slider */
        ...
        $form->setHtmlIdPrefix('slider_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_slider_edit_tab_content_prepare_form', ['form' => $form]);
