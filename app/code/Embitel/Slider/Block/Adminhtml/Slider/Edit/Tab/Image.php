<?php
namespace Embitel\Slider\Block\Adminhtml\Slider\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'slider_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_slider_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Embitel\Slider\Block\Adminhtml\Form\Element\Image'];
    }
}
