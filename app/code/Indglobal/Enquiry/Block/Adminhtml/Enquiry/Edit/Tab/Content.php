    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Indglobal\EnquiryModel\Enquiry */
        ...
        $form->setHtmlIdPrefix('enquiry_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_enquiry_edit_tab_content_prepare_form', ['form' => $form]);
