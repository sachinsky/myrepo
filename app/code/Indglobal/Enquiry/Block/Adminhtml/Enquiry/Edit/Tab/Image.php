    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'enquiry_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_enquiry_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Indglobal\Enquiry\Block\Adminhtml\Form\Element\Image'];
    }
}
