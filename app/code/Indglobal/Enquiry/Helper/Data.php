 ...
 * Enquiry data helper
 */
namespace Indglobal\Enquiry\Helper;
...
{
    /**
     * Path to store config where count of enquiry posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'enquiry/view/items_per_page';
    ...
    /**
     * Remove Enquiry item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Indglobal\Enquiry\Model\Enquiry $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Enquiry Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Enquiry Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getEnquiryPerPage()
    {
