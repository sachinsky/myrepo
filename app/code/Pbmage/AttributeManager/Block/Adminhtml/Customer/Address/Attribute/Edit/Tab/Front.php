 ...
 */
namespace Pbmage\AttributeManager\Block\Adminhtml\Customer\Address\Attribute\Edit\Tab;

class Front extends \Magento\Backend\Block\Widget\Form\Generic
{
    public $yesNo;
    public $usedCustomerAddressForms;
    ...
    public function __construct(
        ...
        \Pbmage\AttributeManager\Model\Config\Source\UsedCustomerAddressForms $usedCustomerAddressForms,
        \Magento\Eav\Block\Adminhtml\Attribute\PropertyLocker $propertyLocker,
        array $data = []
    ) {
        $this->yesNo = $yesNo;
        $this->usedCustomerAddressForms = $usedCustomerAddressForms;
    ...
    public function _prepareForm()
    {
        ...
        $usedCustomerAddressFormsSource = $this->usedCustomerAddressForms->toOptionArray();
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values'   => $usedCustomerAddressFormsSource,
