 ...
 */
namespace Pbmage\AttributeManager\Block\Adminhtml\Customer\Attribute;

class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    public $_blockGroup = 'Pbmage_AttributeManager';
    ...
    {
        return $this->getUrl(
            'pbmage_attribute_manager/customer/save',
            ['_current' => true, 'back' => null, 'customer_tab' => $this->getRequest()->getParam('customer_tab')]
        );
    }
}
